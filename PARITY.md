...
- **Home niceties** — shift-click range select; fix ascending date-group bucket order; inline Import on the Home list-head; per-row busy indicator.
